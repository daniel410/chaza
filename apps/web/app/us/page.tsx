          ...
          <div className="container relative">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg text-muted-foreground md:text-xl">
                ...
                across major retailers in the United States. All prices in USD.
              </p>
              ...
              {/* Quick Links */}
               <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                 ...
                 {['Pampers', 'Baby Formula', 'Coca-Cola', 'Water'].map((term) => (
                   <Link
                     key={term}
                     href={`/us/search?q=${encodeURIComponent(term)}`}
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {popularCategories.map((cat) => (
                <Link key={cat.category} href={`/us/category/${cat.category.toLowerCase()}`}>
              ...
              <div className="p-6 py-12 px-8 md:px-16 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button asChild variant="secondary" size="lg">
                    <Link href="/us/register">Create Free Account</Link>
                  </Button>
                  <Button asChild variant="outline" size="lg">
                    <Link href="/us/search">Start Comparing</Link>
                  </Button>
                </div>
              </div>
            </div>
